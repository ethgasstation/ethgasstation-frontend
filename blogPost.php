<?php 
  ...
  echo "<a href=" . $link . " class='post_title' target='_blank'>" . $decodedData[0]->title->rendered . "</a><a href=" . $link . " class='post_external_link' target='_blank'>Read on EGS NEWS <img class='right_arrow' src='/images/right-arrow.svg'> </a>";
?>