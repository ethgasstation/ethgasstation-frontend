...
y, X = dmatrices('logCTime ~ hashPowerAccepting + gasOffered + pctLimitGasAbove + pctLimitGasAt + pctLimitGasBelow + txAbove + txAt + txBelow', data = predictData, return_type = 'dataframe')
