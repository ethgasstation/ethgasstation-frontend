...
predictTable['sum'] = predictTable['intercept'] + (predictTable['hashPowerAccepting']*predictTable['hashPowerCoef']) + (predictTable['transfer']*predictTable['tfercoef']) + (predictTable['pctLimitGasAbove']* predictTable['pctLimitGasAboveCoeff']) + (predictTable['pctLimitGasAt'] * predictTable['pctLimitGasAtCoeff']) + predictTable['totalTxVal']

predictTable['sumC'] = predictTable['intercept'] + (predictTable['hashPowerAccepting']*predictTable['hashPowerCoef']) + (predictTable['pctLimitGasAbove']* predictTable['pctLimitGasAboveCoeff']) + (predictTable['pctLimitGasAt'] * predictTable['pctLimitGasAtCoeff']) + predictTable['totalTxVal']
...
def getSafeLow():
    ...
    series2 = memPoolAvg.loc[memPoolAvg['waitBlocks'], 'gasPrice' <= 45]
    safe = series2.min()
    print ('safe ' . str(safe))
    print(minHashList)
