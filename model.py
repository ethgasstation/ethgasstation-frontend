...
y, X = dmatrices('logCTime ~ hashPowerAccepting + gasOffered + pctLimitGasAbove + pctLimitGasAt + pctLimitGasBelow + totalTxTxP', data = predictData, return_type = 'dataframe')
