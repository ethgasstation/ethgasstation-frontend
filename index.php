        ...
        <div class="top_nav">
          <div class="nav_menu">
            <nav>
              ...
              <p class="navbar-text navbar-right" style="padding-right:5px"><strong><?php echo "Estimates over last 10,000 blocks - Last update: Block <span style = 'color:#1ABB9C'> $latestblock" ?></strong></span></p>
            </nav>
          </div>
         </div>
