...
y, X = dmatrices('confirmTime ~ transfer + hashPowerAccepting + pctLimitGasAbove + pctLimitGasAt + totalTxTxP + gasOffered + txAbove + txAt', data = predictData, return_type = 'dataframe')
