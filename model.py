...
y, X = dmatrices('logCTime ~ hashPowerAccepting + gasOffered + pctLimitGasAbove + pctLimitGasAt + pctLimitGasBelow + txAbove + txAt + txBelow + gasPrice', data = predictData, return_type = 'dataframe')
