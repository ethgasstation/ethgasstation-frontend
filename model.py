...
y, X = dmatrices('logCTime ~ hashPowerAccepting + gasOffered + pctLimitGasAbove + pctLimitGasAt + pctLimitGasBelow + txAbove + txAt + txBelow + totalTxTxP', data = predictData, return_type = 'dataframe')
