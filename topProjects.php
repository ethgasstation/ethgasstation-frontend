  ...
  */
  ...
  foreach($decodedData as $data) {
    ...
    if ($data->project == "unknown") {
      ...
      echo "<tr><td>". $counter++ . "</td><td><span data-template=" . $data->projectId . " class='top_project'>" . $data->project . "</span>" . $spamLink . "</td><td>". $data->costETH ."</td><td>". $data->avgGwei ."</td><td>$". $data->costUsd ."</td></tr>";
    }
